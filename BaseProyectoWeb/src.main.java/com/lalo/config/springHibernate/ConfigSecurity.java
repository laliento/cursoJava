...
//				.passwordEncoder(new StandardPasswordEncoder("lalum@"))
    ...
    protected void configure(HttpSecurity http) throws Exception {
      ...
      .and().authorizeRequests()
        ...
        .antMatchers("/pages/admin/**").hasRole("ADMIN") //hasRole añade el prefijo _ROLE
        ...
        .and().formLogin()  
            ...
            .defaultSuccessUrl("/pages/admin/admin.xhtml")
	        .permitAll()
	     .and().logout()    
			.logoutUrl("/appLogout") 
			.logoutSuccessUrl("/login.xhtml")
			.deleteCookies("JSESSIONID","remember_me_end")
	     .and().httpBasic()// forma de autententicar a un usuario en una apicación directamente / se puede hacer automáticamente con REST
//	     	.realmName("") // nombre del reino ...
	     .and().rememberMe() // usa tokenRepository ó key
	     	...
	     	.tokenValiditySeconds(60)//numero de segundos que está activa la session, por defaul son 2 semanas
