...
@Configuration
@ComponentScan(basePackages = {"com.lalo.base.view","com.lalo.base.bi","com.lalo.base.dao","com.lalo.config.view"})// por default toma el paquete donde est� ubicada �sta clase
		...
		return new Properties() {
			{
				...
				setProperty("hibernate.hbm2ddl.auto", "validate");//update(pasa los cambios de hibernate a la BD),validate(s�lo valida)
